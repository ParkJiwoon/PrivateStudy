...
- [4. 테스트 케이스 실행 및 로그 확인](#4-테스트-케이스-실행-및-로그-확인)
...
- Spring AMQP (Advanced Message Queuing Protocol) 와 프로젝트 리액터를 활용한 웹 계층과 백엔드의 결합 관계 해서
...
**JSON 직렬화 담당하는 Jackson 라이브러리 적용**
